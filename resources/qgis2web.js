...
map.getView().fit([-11789325.327460, 3431955.362737, -11786993.163413, 3433848.919593], map.getSize());
...
var Title = new ol.control.Control({
    element: (() => {
        ...
        titleElement.innerHTML = '<h2 class="project-title">Sol.524 Agricultires del Decierto SA.de SB Análisis Multitemporal</h2>';
        return titleElement;
    })(),
    ...
    element: (() => {
        ...
        if (747 > 240) {
            ...
            window.showAbstract = function() {
                ...
                linkElement.innerHTML = 'Datos climatologicos :<br /><br /><iframe src=\'https://www.weatherlink.com/embeddablePage/show/6016ef60a009494aa2edbcbdcdfae2cb/summary\' width=\'560\' height=\'480\' frameborder=\'0\'></iframe><br /><br />Este mapa web ofrece un análisis multitemporal detallado del cultivo de algodón, integrando imágenes satelitales de diversas fechas y datos de alta resolución capturados con drones multiespectrales. El objetivo principal es evaluar la salud vegetal, las condiciones generales del cultivo y realizar una zonificación precisa del estado del mismo, considerando factores como la etapa fenológica, áreas de interés específicas y el seguimiento de siniestros.<br /><br />Desarrollado por:<br />Ing. Oscar Montana<br />Departamento de SIGMA del Fondo de Aseguramiento Agropecuario FORTSCHRITT<br /><br />';
            }
